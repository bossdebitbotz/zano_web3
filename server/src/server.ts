...
class ServerWallet {
  ...
  private walletAuthToken: string | null;
  private enableTransactionLogging: boolean;
  private authRequired: boolean;
  private transactionLogs: TransactionLogEntry[] = [];
  ...
  async sendTransferWithLogging(assetId: string, address: string, amount: string, comment?: string) {
    if (this.enableTransactionLogging) {
